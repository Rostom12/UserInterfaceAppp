...
class MainActivity : AppCompatActivity() {
    ...
    btnNextActivity.setOnClickListener { // Ce code permet de définir une action pour le clic sur le bouton, en créant une 'intent' qui démarre `SecondActivity`.
    ...
    navView.setNavigationItemSelectedListener {
        // Ce Listener permet de gérer les actions lorsqu'un élément du menu de navigation est sélectionné, comme rediriger vers une activité spécifique.
        when (it.itemId) {
            R.id.nav_main -> {
